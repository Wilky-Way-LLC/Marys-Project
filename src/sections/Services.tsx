  ...
  return (
    <section id="Services" className="bg-[#F8FAFC] px-6 sm:px-12 md:px-20 py-20 text-plum text-center">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 max-w-7xl mx-auto">
        {/* Therapy */}
        <div className="group bg-[#EEF7F9] rounded-xl px-10 py-10 flex flex-col items-center text-center space-y-4 transition-all duration-300 hover:shadow-sm hover:scale-[1.03] hover:bg-[#e0f2f5]/70">
          <img
            src="/therapy-services.svg"
            alt="Therapy Icon"
            className="w-24 h-24 transition-transform duration-300 group-hover:-rotate-6"
          />
        ...
        {/* Groups */}
        <div className="group bg-[#E6F3F4] rounded-xl px-10 py-10 flex flex-col items-center text-center space-y-4 transition-all duration-300 hover:shadow-sm hover:scale-[1.03] hover:bg-[#daf0f2]/90">
          <img
            src="/groups.svg"
            alt="Groups Icon"
            className="w-24 h-24 transition-transform duration-300 group-hover:rotate-6"
        ...
        <div className="group bg-[#EEF7F9] rounded-xl px-10 py-10 flex flex-col items-center text-center space-y-4 transition-all duration-300 hover:shadow-sm hover:scale-[1.03] hover:bg-[#e0f2f5]/70">
          <img
            src="/group-services.svg"
            alt="Coaching Icon"
            className="w-24 h-24 transition-transform duration-300 group-hover:-rotate-3"
          />
