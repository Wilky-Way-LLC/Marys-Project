        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-12 flex-1">
          ...
          <div>
            ...
            <div className="flex items-center gap-2 mb-4">
              ...
              <a href="mailto:allmadheretherapysolutions@outlook.com" className="hover:text-white transition hover:opacity-80 hover:underline text-wrap break-all">allmadheretherapysolutions@outlook.com</a>
            </div>
